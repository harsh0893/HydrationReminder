...
//            Log.v("batteryManager",batteryManager.isCharging()+"");
...
//        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            int status = batteryStatus.getExtras().getInt(BatteryManager.EXTRA_STATUS);
